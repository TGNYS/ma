local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/TGNYS/ma/refs/heads/main/ui"))()      
local win = ui:new("凡尘脚本中心V2")
--
...
about:Label("拒绝倒卖")
about:Label("作者：凡尘")
about:Label("感谢夜路，我的朋友")
about:Label("感谢支持我的人")
about:Label("本脚本为V2版本")
about:Label("已支持俄亥俄州")
about:Button("点我复制作者QQ",function()
    setclipboard("2846706821")
end)

about:Button("点我复制凡尘脚本官方群",function()
    setclipboard("56117318118")
end)

about:Button("点我复制凡尘脚本二群",function()
    setclipboard("715266495")
end)
